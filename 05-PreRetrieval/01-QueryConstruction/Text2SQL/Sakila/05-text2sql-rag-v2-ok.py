...
def text2sql(question: str):
    ...
    # 9.3 RAG retrieval: example pairs
    ...
    # 9.4 RAG retrieval: field descriptions
    ...
    # 9.6 Call the latest Response API
