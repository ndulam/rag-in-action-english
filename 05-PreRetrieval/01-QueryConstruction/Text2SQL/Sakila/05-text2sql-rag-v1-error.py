...
def text2sql(question: str):
    ...
    # 8.3 RAG retrieval: example pairs
    ...
    # 8.4 RAG retrieval: field descriptions
    ...
    logging.info("[Generation] Starting SQL generation")

    # 8.6 Call the latest Response API
    ...
    logging.info(f"[Generation] Generated SQL: {sql}")

    # 8.7 Execute and print results
    try:
        ...
        logging.error(f"[Execution] Execution failed: {e}")
